...
// Datos de Red
const char* ssid = "INFINITUM29A4_2.4";  // Pon aquí el nombre de la red a la que deseas conectarte
const char* password = "2gPXRJ28bg";  // Escribe la contraseña de dicha red
